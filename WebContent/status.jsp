		...
		<div id="home">
			...
			&nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp
			 &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp
							<h:commandLink styleClass="hiperLink" value="Logar"
							action="#{clienteBean.logar }"></h:commandLink>
					</h:panelGrid>
					...
					<rich:dataTable id="Liberarr"
						...
						binding="#{clienteBean.objTabela }" rows="40">
						...
						<rich:column>
							<h:commandButton image="#{c.fone2 }" />
						</rich:column>
						<rich:column>
							<h:commandButton image="#{c.retorno }" />
						</rich:column>
						<rich:column>
							<h:commandButton image="#{c.renovacao }" />
						</rich:column>
						<rich:column>
							<h:commandButton image="LayoutNovo/Imagem/editar.png" />
						</rich:column>
						<rich:column>
							<h:commandButton image="LayoutNovo/Imagem/remover.png" />
						</rich:column>
						<f:facet name="footer">
